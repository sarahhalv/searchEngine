...
public class HtmlCleaner {
	...
	public static String stripEntities(String html) {	
		String sansEntities = html.replaceAll("&[^\\s]+?;", "");
		return sansEntities;
	}
	...
	public static String stripTags(String html) {
		String sansTags = html.replaceAll("<[\\s\\S]+?>", "");
		return sansTags;
	}
	...
	/**
	 * looks and replaces new lines with the appropriate space
	 * 
	 * @param foo the string to pass in 
	 * @return the appropariate string with space
	 */
	public static String lookForNewLine(MatchResult foo) {
		String match = foo.group();
